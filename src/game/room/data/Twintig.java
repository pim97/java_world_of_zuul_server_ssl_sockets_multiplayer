...
public class Twintig extends RoomAbstractLoading {

	public Twintig(Game game) {
		super(game);
	...
	public ArrayList<NPC> loadNPCs() {
		return new ArrayList<NPC>(Arrays.asList(new NPC[] {
				new NPC(this, "Congratulator", 5000, 10,
	...
	public void actionOnLoadRoom() {
		// TODO Auto-generated method stub
		getGame().printText("You've completed the Game of Thrones game! Congratulations! Here some cookies.");
		getGame().getPlayer().addItemToInventory("Cookie", 100);
	}
