...
public enum CommandWordsEnum
{
	...
	MYPLAYER("Will display information about you"),
	...
	public static CommandWordsEnum getCommand(String command) {
		for (CommandWordsEnum comm : values()) {
     ...
     */
    CommandWordsEnum(String instruction)
    {
